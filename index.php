...
<html class="wide wow-animation" lang="en">
  <head>
    <title>Comunidad Cristiana Familias para Cristo</title>
    <meta charset="utf-8">
      ...
      <div class="container">
          <div class="row justify-content-center">
            <div class="col-xl-12 text-center">
              <h2 class="font-weight-bold text-primary wow fadeInUp" data-wow-delay=".1s">Comunidad Cristiana Familias para Cristo</h2>
              <p class="wow fadeInUp text-sm" data-wow-delay=".2s"></p>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-xl-8 col-lg-10">
              <div class="pre-title wow fadeInLeft" data-wow-delay=".1s">Bienvenidos</div>
              <h2 class="wow fadeInRight" data-wow-delay=".2s">Existimos de parte de Dios, para llevar a las familias al conocimiento de Cristo.</h2>
              <p class="text-sm wow fadeInUp" data-wow-delay=".3s">Y Él mismo constituyó a unos, apóstoles; a otros, profetas; a otros, evangelistas; a otros, pastores y maestros, a fin de perfeccionar a los santos para la obra del ministerio, para la edificación del cuerpo de Cristo.<br> Efesios 4:11-12 RVR1960</p>
              <a class="shadow btn btn-icon btn-icon-right btn-secondary btn-svg offset-xl-55 wow fadeInUp" href="about-us.php" data-wow-delay=".3s"><span class="svg-icon">
                  ...
                  </svg></span><span>Más sobre nosotros</span></a>
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="row row-narrow-66 row-40">
            <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay=".1s">
              <div class="post-classic">
                ...
                <div class="post-classic__caption"><span class="post-info">Familias para Cristo, 30 de Setiembre, 2020 </span>
